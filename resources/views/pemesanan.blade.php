    ...
    <main class="main">
                ...
                {{-- <div class="form-group">
                  ...
                  <section class="application-form" style="margin-top: 130px">
                    <div class="container">
                      <h2 class="text-center">Formulir Pemesanan Website</h2>
                      <form action="{{ route('pesanan.store') }}" method="POST" id="job-application-form" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="access_key" value="cb7aa505-86dd-4946-b3ee-56aa80bc716f">

                        <input type="hidden" name="subject" value="Pemesanan Website">
                        <div class="form-group">
                          <label for="nama" style="font-weight: 500; margin-bottom: 5px; display: block;">Nama Lengkap :</label>
                        ...
                        <div class="form-group">
                            <label for="deskripsi" style="font-weight: 500; margin-bottom: 5px; display: block;">Deskripsi :</label>
                            <textarea id="deskripsi" name="deskripsi" class="form-control" placeholder="Deskripsikan pesanan Website!" rows="6" required></textarea>
                          </div>
